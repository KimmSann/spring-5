...
import com.example.demo.Project05Application;
import com.example.demo.dtp.BookDTO;
import com.example.demo.dtp.PersonDTO;
...
public class QuizController {
    ...
    private final Project05Application project05Application;

    QuizController(Project05Application project05Application) {
        this.project05Application = project05Application;
    }
    ...
    public void ex6(Model  model) {
    	java.util.List<PersonDTO> dtoList = new ArrayList<>();
